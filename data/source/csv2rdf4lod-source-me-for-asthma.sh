...
export CSV2RDF4LOD_BASE_URI="http://lod.theasthmafiles.org"
...
export CSV2RDF4LOD_PUBLISH_OUR_SOURCE_ID="theasthmafiles-org"
...
export CSV2RDF4LOD_PUBLISH_DATAHUB_METADATA_OUR_BUBBLE_ID="theasthmafiles"
